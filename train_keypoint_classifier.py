...
# -*- coding: utf-8 -*-
"""
Training script for the keypoint classifier model.
This script trains a neural network to classify hand gestures based on hand landmarks.
"""
...
def get_args():
    parser = argparse.ArgumentParser(description='Train keypoint classifier')
    parser.add_argument('--dataset', type=str, default='model/keypoint_classifier/keypoint.csv',
                        help='Path to the training dataset CSV')
    parser.add_argument('--model_save_path', type=str, default='model/keypoint_classifier/keypoint_classifier.keras',
                        help='Path to save the trained model')
    parser.add_argument('--tflite_save_path', type=str, default='model/keypoint_classifier/keypoint_classifier.tflite',
...
def load_dataset(csv_path):
    ...
    # Load features (hand landmarks, 21 points x 2 coordinates = 42 features)
    X = np.loadtxt(csv_path, delimiter=',', dtype='float32', usecols=list(range(1, (21 * 2) + 1)))
    # Load labels
...
def create_model(num_classes=8):
    """Create the keypoint classifier model."""
...
def main():
    ...
    print("=" * 60)
    print("Keypoint Classifier Training")
    print("=" * 60)
